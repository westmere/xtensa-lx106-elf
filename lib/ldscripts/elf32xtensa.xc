...
ENTRY(_start)
SEARCH_DIR("=/mnt/vinh/DATA/ST/sources/ESP8266/esp-open-sdk/xtensa-lx106-elf/xtensa-lx106-elf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
